...
public class FeedCSV {
    ...
    public FeedCSV(String name, String symbol) {
        this.name = name;
        this.symbol = symbol;
        data = addTradeData();
    }

    public FeedCSV(String name, String symbol, String format) {
        this.name = name;
        this.symbol = symbol;
...
//            td.volume[i] = Double.parseDouble(line.get(5));
        }
        return td;
    }
